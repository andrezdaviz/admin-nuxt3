<template>
  <div class="w-56 text-right">
    <Menu as="div" class="relative z-50 inline-block text-left">
      ...
      >
        <MenuItems
          class="absolute right-0 w-56 mt-2 origin-top-right divide-y divide-gray-100 rounded-md shadow-lg bg-fg ring-1 ring-black ring-opacity-5 focus:outline-none"
        >
          <div class="px-1 py-1">
